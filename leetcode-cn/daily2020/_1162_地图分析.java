...
public class _1162_地图分析 {
    ...
    public static void main(String[] args) {
        System.out.println((new Solution()).maxDistance(new int[][]{{1, 0, 1}, {0, 0, 0}, {1, 0, 1}}));
        System.out.println((new Solution()).maxDistance(new int[][]{{1, 0, 0}, {0, 0, 0}, {0, 0, 0}}));
        System.out.println((new Solution()).maxDistance(new int[][]{{0, 0, 0}, {0, 0, 0}, {0, 0, 0}}));
    }
